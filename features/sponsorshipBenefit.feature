Feature: Sponsorship Benefit
  ...
  Scenario: I add a sponsorship benefit
    ...
    When I am on "sponsorship-benefit/create"
    And I fill in "sponsorship_benefit[label]" with "Benefit 11"
    And I press "Save"
  ...
  Scenario: I don't fill all data needed when i edit a sponsorship benefit "Benefit 11"
    Given I am logged in as an admin
    When I am on "sponsorship-benefit/"
    And I click "Edit" on the row containing "Benefit 11"
    And I fill in "sponsorship_benefit[label]" with ""
    And I press "Update"
    Then I should see "This value should not be blank."
  ...
  Scenario: I edit the sponsorship benefit "Benefit 11"
    ...
    When I am on "sponsorship-benefit/"
    And I click "Edit" on the row containing "Benefit 11"
    And I fill in "sponsorship_benefit[label]" with "Benefit 12"
    And I press "Update"
    Then I should be on "sponsorship-benefit/"
