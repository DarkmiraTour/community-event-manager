...
namespace App\Sponsorship\SponsorshipBenefit\Edit;

use App\Action;
use App\Sponsorship\SponsorshipBenefit\SponsorshipBenefitRequest;
use App\Sponsorship\SponsorshipBenefit\SponsorshipBenefitFormType;
...
final class EditAction implements Action
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $form = $this->formFactory->create(SponsorshipBenefitFormType::class, $sponsorshipBenefitRequest, [
